        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="#"
                className="hover:text-[#C599A6] transition-colors text-sm"
              >
                Điều Khoản Thuê
              </a>
            </li>
          ...
          <ul className="space-y-3 text-sm leading-relaxed">
            <li>
              <div className="flex items-center gap-3">
                <MapPin className="w-5 h-5 text-[#C599A6]" aria-hidden />
                <span>141 Điện Biên Phủ, Phường Gia Định,</span>
              </div>
              <span className="ml-[12%]">TP Hồ Chí Minh</span>
            </li>
            <li className="flex items-center gap-3">
              <Mail className="w-5 h-5 text-[#C599A6]" aria-hidden />
              <a
                href="mailto:hello@thejulia.vn"
                className="hover:text-[#C599A6]"
              >
                hello@thejulia.vn
              </a>
            </li>
            <li className="flex items-center gap-3">
              <Phone className="w-5 h-5 text-[#C599A6]" aria-hidden />
              <a href="tel:+84" className="hover:text-[#C599A6]">
                +84 xxx xxx xxx
              </a>
            </li>
          </ul>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="hover:text-[#C599A6] transition-colors"
            >
