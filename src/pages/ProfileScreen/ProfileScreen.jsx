...
export default function ProfileScreen() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-surface via-surface to-background-alt px-4 sm:px-6 py-14">
        <div className="max-w-3xl mx-auto space-y-4 animate-pulse">
          ...
          <div className="h-72 bg-background-alt" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-surface via-surface to-background-alt px-4 sm:px-6 py-14 relative overflow-hidden">
      ...
      >
        {/* ── Hero strip ── */}
        <div className="bg-gradient-to-r from-primary via-primary to-primary px-6 py-7 flex items-center justify-between gap-5">
          ...
          <AnimatePresence mode="wait">
            ...
            {isEditing && (
              ...
              >
                ...
                {/* action bar */}
                <div className="flex justify-end gap-3 mt-8 pt-5 border-t border-background-alt">
                  <motion.button
                    id="btn-cancel-edit"
